@{
    ...
    RootModule        = 'Invoke-AttackLib.psm1'
    ...
    Description       = 'A PowerShell module that runs Attack Lib tests from yaml definition files.'
    ...
    # AttackLibClassSchema.ps1 needs to be present in the caller's scope in order for the built-in classes to surface properly.
    ScriptsToProcess  = @('Private\AttackLibClassSchema.ps1', 'Public\config.ps1')

    # Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
    FunctionsToExport = @(
        'Invoke-AttackLibTest',
        'Get-AttackLibTechnique',
        'New-AttackLibTechnique',
        'New-AttackLibTest',
        'New-AttackLibTestInputArgument',
        'New-AttackLibTestDependency',
        'Start-AttackLibGUI',
        'Stop-AttackLibGUI',
        'Invoke-SetupAttackLibRunner',
        'Invoke-GenerateNewSchedule',
        'Invoke-RefreshExistingSchedule',
        'Invoke-AttackLibRunner',
        'Get-Schedule',
        'Invoke-KickoffAttackLibRunner',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            LicenseUri   = 'https://github.com/redcanaryco/invoke-attacklib/blob/master/LICENSE.txt'

            # A URL to the main website for this project.
            ProjectUri   = 'https://github.com/redcanaryco/invoke-attacklib'
