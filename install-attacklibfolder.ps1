function Install-AtomicsFolder {
    ...
    .SYNOPSIS
        ...
        This is a simple script to download the atttack definitions in the "atomics" folder of the Red Canary Attack Lib project.
...
#>
    ...
    Try {
        ...
        if ($Force -or -Not (Test-Path -Path $InstallPathwAtomics )) {
            ...
            $url = "https://github.com/$RepoOwner/attack-lib/archive/$Branch.zip"
            ...
            if ($NoPayloads) {
                ...
                # load ZIP methods
                Write-Host -ForegroundColor Yellow "Reading the Attack Lib repo into a memory stream. This could take up to 3 minutes."
                ...
                $atomicsFolderUnzipped = Join-Path (Join-Path $zipDest "attack-lib-$Branch") "atomics"
