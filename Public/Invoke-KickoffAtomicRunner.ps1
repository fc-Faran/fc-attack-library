function Invoke-KickoffAtomicRunner {
    ...
    if ($artConfig.debug) { $Arguments = "-Command Invoke-AttackLibRunner *>> $all_log_file" } else { $Arguments = "-Command Invoke-AttackLibRunner" }
    ...
    if ($artConfig.debug) { $Arguments = "-Command Invoke-AttackLibRunner -scheduledTaskCleanup *>> $all_log_file_cleanup" } else { $Arguments = "-Command Invoke-AttackLibRunner -scheduledTaskCleanup" }
